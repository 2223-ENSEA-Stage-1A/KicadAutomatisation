...
def Run(path, name, configPath):
    ...
    if(doAble): 
        raw_drc_result, raw_erc_result, raw_gerber_and_drill_result = doKibotStuff(KicadPcb_path, configPath) #doesKibotStuff
        ...
        erc_warning, erc_warnings, erc_error, erc_errors = handle_erc_result(ERCresultf.readlines()) if ERCresultf else None,None,None,None

    print(raw_drc_result)
...
def doKibotStuff(KicadPcb_path, configPath):
    ...
    return drcResult, ercResult, gerberAndDrillResult
