...
from myapp.myscripts.checkThisProject import Run as checkThisProject
...
import subprocess
from .forms import DRCForm, GerberUploadForm
from django.contrib.auth.decorators import login_required

from django.shortcuts import redirect

from .models import AuthorizedError, PanelFile, UploadedFile, ResultFile
...
def logged_home(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            result = checkThisProject(extracted_folder_path, name, "myapp/myscripts/configs")
...
def gerber_result(request):
    ...
    if request.method == 'POST':
        ...
        form = DRCForm(context_from_data['drc_types'])  # Use the existing DRCForm
