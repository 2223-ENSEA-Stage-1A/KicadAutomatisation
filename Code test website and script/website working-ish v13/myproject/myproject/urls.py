...
from myapp.views import get_progress, home, logged_home, profile, user_files, delete_file, file_explorer_view, download_file_view, panelizer_kicad, user_panels
...
urlpatterns = [
    ...
    path('paneledit/<int:file_id>/', panel_edit, name='panel_edit'),
