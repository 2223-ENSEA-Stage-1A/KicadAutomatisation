...
def categorize(trackWidth, clearance, viaSize, numberOfCopperLayer):
    ...
    elif viaSize < 0.4 and trackWidth < 0.2 and clearance < 0.2:
        return "Class 5 or more, not doable yet", True    
    elif viaSize < 0.6 and trackWidth < 0.3 and clearance < 0.3:
        return "Class 4, Pretty tricky, but doable", True
    elif viaSize < 0.8 and trackWidth < 0.5 and clearance < 0.5:
