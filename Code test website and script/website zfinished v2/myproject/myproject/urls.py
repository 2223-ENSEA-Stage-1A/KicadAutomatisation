...
from myapp.views import get_progress, home, logged_home, profile, send_panel_prod, send_project_prod, user_files, delete_file, file_explorer_view, download_file_view, panelizer_kicad, user_panels
